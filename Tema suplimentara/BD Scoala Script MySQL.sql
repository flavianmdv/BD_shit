...
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('1','Aiben','Angela',str_to_date('12/20/1988','%m/%d/%Y'),'F','3241','7','10','3');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('2','Belc','Viorel',str_to_date('05/27/1988','%m/%d/%Y'),'M','3241',null,'10','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('3','Berindean','Coralia',str_to_date('03/21/1989','%m/%d/%Y'),'F','3241',null,'10','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('4','Butmalai','Catalin',str_to_date('02/26/1988','%m/%d/%Y'),'M','3241','15','10','1');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('5','Brad','Marilena',str_to_date('05/14/1986','%m/%d/%Y'),'F','3241',null,'10','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('6','Costin','Ovidiu',str_to_date('07/27/1985','%m/%d/%Y'),'M','3241',null,'10','4');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('7','Costin','Radu',str_to_date('11/04/1986','%m/%d/%Y'),'M','3241','1','10','3');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('8','Demian','Calin',str_to_date('08/04/1986','%m/%d/%Y'),'M','3241','21','10','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('9','Dragan','Teodora',str_to_date('09/23/1986','%m/%d/%Y'),'F','3241','12','10','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('10','Kiss','Zoltan',str_to_date('01/27/1986','%m/%d/%Y'),'M','3241',null,null,'7');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('11','Tabirta','Vadim',str_to_date('07/30/1986','%m/%d/%Y'),'M','3241',null,'10','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('12','Harangus','Dan',str_to_date('01/20/1986','%m/%d/%Y'),'M','3241','9','20','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('13','Muresan','Mirel',str_to_date('01/23/1986','%m/%d/%Y'),'M','3241',null,'20','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('14','Pacurar','Gheorghe',str_to_date('07/24/1985','%m/%d/%Y'),'M','3241',null,'20','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('15','Prata','Adriana',str_to_date('12/26/1986','%m/%d/%Y'),'F','3241','4','20','1');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('16','Sasebes','Claudiu',str_to_date('10/04/1986','%m/%d/%Y'),'M','3241',null,'20','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('17','Roman','Adrian',str_to_date('10/27/1986','%m/%d/%Y'),'M','3241',null,'20','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('18','Tocaciu','Radu',str_to_date('03/28/1985','%m/%d/%Y'),'M','3241',null,'20','10');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('19','Toderici','Leontin',str_to_date('07/03/1984','%m/%d/%Y'),'M','3241',null,'20','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('20','Tudor','Dan',str_to_date('03/22/1985','%m/%d/%Y'),'M','3241',null,null,'5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('21','Vonica','Cosmina',str_to_date('10/02/1986','%m/%d/%Y'),'F','3241','8','20','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('22','Rus','Mircea',str_to_date('06/26/1985','%m/%d/%Y'),'M','3241',null,'20','9');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('23','Alexandru','Mihai',str_to_date('06/23/1984','%m/%d/%Y'),'M','3242',null,null,'8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('24','Babota','Radu',str_to_date('07/29/1985','%m/%d/%Y'),'M','3242',null,'23','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('25','Ceuca','Dana',str_to_date('09/03/1986','%m/%d/%Y'),'F','3242','40','23','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('26','Cornea','Stelian',str_to_date('11/16/1984','%m/%d/%Y'),'M','3242',null,'23','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('27','Cristea','Titus',str_to_date('09/22/1985','%m/%d/%Y'),'F','3242',null,'23','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('28','Galea','Gabriela',str_to_date('10/21/1986','%m/%d/%Y'),'M','3242',null,'23','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('29','Iosivas','Mihai',str_to_date('06/26/1986','%m/%d/%Y'),'M','3242',null,'23','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('30','Lupu','Cristian',str_to_date('12/25/1986','%m/%d/%Y'),'M','3242',null,'23','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('31','Petrescu','Amelia',str_to_date('05/21/1986','%m/%d/%Y'),'F','3242',null,'23','11');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('32','Mirza','Narcis',str_to_date('09/26/1985','%m/%d/%Y'),'M','3242',null,'23','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('33','Cistelecan','Dana',str_to_date('07/02/1986','%m/%d/%Y'),'F','3242',null,'23','12');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('34','Mindru','Adrian',str_to_date('01/23/1986','%m/%d/%Y'),'M','3242',null,'36','14');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('35','Moldovan','Steliana',str_to_date('03/18/1986','%m/%d/%Y'),'F','3242',null,'36','13');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('36','Muresan','Ovidiu',str_to_date('07/20/1986','%m/%d/%Y'),'M','3242',null,null,'10');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('37','Paius','Radu',str_to_date('02/28/1986','%m/%d/%Y'),'M','3242',null,'36','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('38','Plesca','Miana',str_to_date('09/22/1986','%m/%d/%Y'),'F','3242',null,'36','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('39','Preda','Razvan',str_to_date('09/25/1985','%m/%d/%Y'),'M','3242',null,'36','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('40','Rusu','Ovidiu',str_to_date('10/07/1986','%m/%d/%Y'),'M','3242','25','36','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('41','Schillo','Alexandru',str_to_date('06/02/1986','%m/%d/%Y'),'M','3242',null,'36','14');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('42','Topircean','Ioan',str_to_date('12/19/1986','%m/%d/%Y'),'M','3242',null,'36','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('43','Zetea','Tudor',str_to_date('02/19/1986','%m/%d/%Y'),'M','3242',null,'36','15');
